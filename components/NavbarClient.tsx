...
import { ShoppingCart, Languages, User as UserIcon } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-1 sm:gap-3">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="h-11 w-11 sm:h-10 sm:w-10 inline-flex items-center justify-center rounded-lg text-gray-600 hover:text-yellow-600 hover:bg-yellow-50/50 transition-colors relative"
                                ...
                                <>
                                    ...
                                    >
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-2 text-sm hover:bg-yellow-50 transition-colors ${language === 'nl' ? 'bg-yellow-50 text-yellow-600 font-medium' : 'text-gray-700'
                                                }`}
                                            type="button"
                                        >
                                            🇳🇱 Nederlands
                                        ...
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-2 text-sm hover:bg-yellow-50 transition-colors ${language === 'en' ? 'bg-yellow-50 text-yellow-600 font-medium' : 'text-gray-700'
                                                }`}
                                            type="button"
                                        >
                                            🇬🇧 English
                        ...
                        <Link
                            href="/cart"
                            className="relative h-11 w-11 sm:h-10 sm:w-10 inline-flex items-center justify-center rounded-lg text-gray-600 hover:text-yellow-600 hover:bg-yellow-50/50 transition-colors"
                            title={t('nav.cart')}
                        >
